...
backend/src/controllers/collaboration/connectedDrivesController.js
...
/**
 * Get all connected drives for an organization
 */
 ...
 * Connect a new drive
 */
const connectDrive = async (req, res, next) => {
  try {
 ...
 * Disconnect a drive
 */
const disconnectDrive = async (req, res, next) => {
  try {
...
/**
 * Get permissions for a drive
 */
const getDrivePermissions = async (req, res, next) => {
  try {
...
/**
 * Assign a single permission to a drive
 */
const assignDrivePermission = async (req, res, next) => {
  try {
...
/**
 * Assign bulk permissions to a drive
 */
const assignBulkDrivePermissions = async (req, res, next) => {
  try {
...
/**
 * Remove a permission from a drive
 */
const removeDrivePermission = async (req, res, next) => {
  try {
...
module.exports = {
  ...
  disconnectDrive,
  getDrivePermissions,
  assignDrivePermission,
  assignBulkDrivePermissions,
